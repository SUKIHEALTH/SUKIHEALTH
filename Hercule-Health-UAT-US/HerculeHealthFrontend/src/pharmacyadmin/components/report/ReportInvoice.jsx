        ...
        <div className="page-wrapper">
          <div className="content container-fluid">
            ...
            <div className="invoice-container">
              ...
              <div className="row">
                <div className="col-sm-6 col-lg-7 col-xl-8 mb-4">
                  <h6>Invoice to</h6>
                  <ul className="list-unstyled mb-0">
                    <li>
                      <h5 className="mb-0">
                    ...
                    <li>8286329170</li>
                    <li>
                      <a href="#">charlenereed@example.com</a>
                    </li>
                  </ul>
                </div>
                <div className="col-sm-6 col-lg-5 col-xl-4 mb-4">
