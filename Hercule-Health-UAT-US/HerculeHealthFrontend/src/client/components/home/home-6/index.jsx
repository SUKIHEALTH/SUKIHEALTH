      ...
      <section className="special-section">
        <div className="container">
          ...
          <div className="special owl-them aos" data-aos="fade-up">
            <OwlCarousel {...specialSlider}>
              <div className="item">
                <div className="special-item">
                  <div className="special-img">
                    <Link to="consultation.html">
                      <ImageWithBasePath
                  ...
                  <h6>
                    <Link to="consultation.html">Cataract</Link>
                  </h6>
                </div>
              </div>
              <div className="item">
                <div className="special-item">
                  ...
                  <h6>
                    <Link to="consultation.html">Corneal Ulcer </Link>
                  </h6>
                </div>
              </div>
              <div className="item">
                <div className="special-item">
                  ...
                  <h6>
                    <Link to="consultation.html">Keratoconus</Link>
                  </h6>
                </div>
              </div>
              <div className="item">
                <div className="special-item">
                  ...
                  <h6>
                    <Link to="consultation.html">Glaucoma</Link>
                  </h6>
                </div>
              </div>
              <div className="item">
          ...
          <div className="row">
            ...
            <div className="col-lg-7 aos" data-aos="fade-up">
              <div className="center-info">
                ...
                <p>
                  At Hercule Health, we understand the importance of clear vision and
              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="care-box">
                    ...
                    <Link to="doctor-search-grid.html">
                      Find Doctors
          ...
          <div className="row">
            <div className="col-md-12 aos" data-aos="fade-up">
              <div className="section-heading text-center sec-heading-eye">
                ...
                <p>Great Reasons For People Choose Hercule Health Store</p>
              </div>
