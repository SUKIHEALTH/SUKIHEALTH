...
const Password = (props) => {
  ...
  useEffect(() => {
    ...
    if (userId) {
      axios
        .get(`/api/consultant-profile-information/${userId}`)
        .then((response) => {
          const email = response.data?.consultant?.information?.email || "";
            ...
            <div className="col-lg-8 col-xl-9">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-set-button d-flex justify-content-end">
                  ...
                  <button className="btn" style={{ backgroundColor: "#008080", color: "#fff" }} type="submit" >
                    Save Changes
                  </button>
                </div>
              </form>
