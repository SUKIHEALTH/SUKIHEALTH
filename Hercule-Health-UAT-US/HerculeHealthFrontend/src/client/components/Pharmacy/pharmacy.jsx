...
import PharmacyHeader from "./pharmacyHeader.jsx";
...
useEffect(() => {
  ...
  document.getElementsByTagName("body")[0].className = "pharmacy-body";
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
              ...
              <div className="pharmacy-btn aos" >
                <Link to="/Pharmacy/pharmacy-search" className="btn">
                  Shop Now
                </Link>
              </div>
            </div>
              ...
              <div className="col-md-8">
                <div className="welcome-info">
                  ...
                  <div className="welcome-content">
                    <h5>Welcome to Hercule Health</h5>
                    <p>
