...
import logo1 from "../../../public/assets/images/HerculeHealth.png";
import AOS from "aos";
import "../../client/assets/css/Signuplogo.css";
...
const Header = () => {
  ...
  const [doctorData, setDoctorData] = useState({
    ...
    loginTime: null, // Store login time here
  });
  ...
  const [patientData, setPatientData] = useState({
    name: "Loading...",
    condition: "Loading...", // Example patient data
    loginTime: null, // Store login time here
  });
  ...
  console.log("this is acesstype in HEADER",accessType)
  useEffect(() => {
    AOS.init({
      duration: 1200,
      once: true,
  ...
  // Fetch user profile (for both patient and doctor)
  const fetchUserProfile = async () => {
    ...
    try {
      ...
      setUserData({
        ...
        loginTime: user.loginTime, // Assuming the API returns login time
      });
      setLoading(false);
    } catch (err) {
  ...
  // Fetch doctor profile (only if the user is a doctor)
  const fetchDoctorProfile = async () => {
    ...
    try {
      ...
      setDoctorData({
        name: consultant?.information?.displayName,
        profileImage: consultant?.profileImage,

        specialization: consultant.specialization,
        loginTime: consultant.loginTime, // Assuming the API returns login time
      });
  ...
  console.log(`this is logout user ${userData}`);
        ...
        >
          <div className="container">
            ...
            >
              <div className="navbar-header">
                ...
                <Link to="#" className=" img-logo">
                  {pathnames.includes("/index-5") ? (
                    ...
                    <img
                      src={
                        pathnames === "/index-6" || pathnames === "/index-4"
                          ? logosvg
                          : pathnames === "/index-11"
                          ? logo_15
                          : pathnames === "/index-10"
                ...
                >
                  ...
                  (pathnames.includes("/aboutus") &&
                    ...
                    <>
                      ...
                      {!pathnames.includes("/index-13") &&
                      !pathnames.includes("about-us") &&
                      !pathnames.includes("contact-us") &&
                      !pathnames.includes("terms-and-conditions")&&
                      !pathnames.includes("privacy-policy") &&
                      !pathnames.includes("customer-speaks") &&
                      !pathnames.includes("in-the-news") &&
                      !pathnames.includes("careers") &&
                      !pathnames.includes("shipping-delivery") &&
                      !pathnames.includes("fees-and-payments") &&
                        !pathnames.includes("/index-5") &&
                        !pathnames.includes("/index-6") &&
                        !pathnames.includes("/index-7") &&
                        !pathnames.includes("/index-8") &&
              ...
              {(!pathnames.includes("/patient/search-doctor1") &&
                pathnames.includes("patient") || pathnames.includes("about-us")) ||
                 pathnames.includes("contact-us") ||
                 pathnames.includes("customer-speaks") ||
                 pathnames.includes("careers") ||
                 pathnames.includes("fees-and-payments") ||
                    ...
                    <li className="nav-item dropdown has-arrow logged-item">
                      ...
                      >
                         ...
                         <img
                           ...
                           src={userData.profileImage || IMG01}
                           width="31"
                           alt="profile"
                         />
                       </span>
                      ...
                      <div className="dropdown-menu dropdown-menu-end">
                        <div className="user-header">
                          <div className="avatar avatar-sm">
                            <img
                              src={
                                userData.profileImage || "/assets/images/doctor-thumb-01.png"
                              } // Fallback to default if no profileImage
                              alt="User Image"
                      ...
                      data-bs-toggle="dropdown"
                        >
                          <span className="user-img">
                            <img
                              className="rounded-circle"
                              src={doctorData?.profileImage || "/assets/images/doctor-thumb-01.png"} // Fallback to default if no profileImage
                              width="31"
                              alt="Profile"
                            />
                          </span>
