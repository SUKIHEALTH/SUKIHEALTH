              ...
              <div className="custom-table">
                <div className="table-responsive">
                  <table className="table table-center mb-0">
                    ...
                    <tbody>
                      <tr>
                      <td><Link to="#" class="text-blue-600" data-bs-toggle="modal" data-bs-target="#invoice_view">#Inv-2021</Link></td>
                        <td>
                      ...
                      <tr>
                      <td><Link to="#" class="text-blue-600" data-bs-toggle="modal" data-bs-target="#invoice_view">#Inv-2023</Link></td>
                        <td>
                          <h2 className="table-avatar">
                            <Link
                              to="/patient/doctor-profile"
