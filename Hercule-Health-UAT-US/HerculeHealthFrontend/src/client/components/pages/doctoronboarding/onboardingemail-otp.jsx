              ...
              <div className="onboarding-content-box content-wrap">
                <div className="onboard-set">
                  <div className="onboarding-title">
                    ...
                    <h6>We’ve sent it to Hercule Health@example.com</h6>
                  </div>
                ...
                <div className="onboarding-btn">
                  <Link to="/pages/onboarding-phone">Continue</Link>
                </div>
              </div>
            </div>
          </div>
...
export default OnboardingEmailOtp;
