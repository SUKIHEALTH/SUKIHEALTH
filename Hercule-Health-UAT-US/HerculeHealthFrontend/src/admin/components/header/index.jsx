        ...
        <ul className="nav user-menu">
          ...
          <li className="nav-item dropdown has-arrow">
            ...
            >
              <span className="user-img">
                <img
                  ...
                  src={"/assets/images/doctor-thumb-01.png"}
                  width={31}
                  alt="Ryan Taylor"
                />
              </span>
            ...
            <div className="dropdown-menu">
              ...
              <Link className="dropdown-item" to="/admin/settings" style={{color: "black"}}>
                Settings
              </Link>
              <Link  onClick={(e) => {
        e.preventDefault(); // Prevent default navigation first
        logout(); // Call logout function
      }} className="dropdown-item" to="/login" style={{color: "black"}}>
                 Logout 
              </Link>
            </div>
          </li>
