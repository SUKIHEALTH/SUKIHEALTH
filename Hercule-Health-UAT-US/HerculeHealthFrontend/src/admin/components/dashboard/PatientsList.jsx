...
const PatientsListDesboard = ({patientList}) => {
  console.log("this is patientsList",patientList)
  const data = [
    {
      id: 1,
      PatientID: "#PT001",
      ...
      render: (text, record) => (
        <>
          <Link className="avatar mx-2" to="/admin/profile">
            <img className="rounded-circle" src={record.profileImage} />
          </Link>
          <Link to="/admin/profile">{`${text.firstName} ${text.lastName}`}</Link>
        </>
      ),
