          ...
          <div className="sidebar-inner slimscroll">
            <div id="sidebar-menu" className="sidebar-menu">
              <ul>
                ...
                <li
                  className={
                    pathname?.includes("/admin/refund-requests")
                      ? "active"
                      : ""
                  }
                >
                  <Link to="/admin/refund-requests">
                    <i className="fe fe-users"></i> <span>Refund requests</span>
                  </Link>
                </li>
                {/* <li
                  className={pathname?.includes("/admin/specialities") ? "active" : ""}
                >
                ...
                <li
                  className={pathname?.includes("admin-invoices") ? "active" : ""}
                >
                  <Link to="/admin/admin-invoices">
                    <i className="fe fe-user"></i> <span>Invoices</span>
                  </Link>
                </li>
